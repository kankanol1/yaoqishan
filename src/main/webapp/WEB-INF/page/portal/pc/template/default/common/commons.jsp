...
<!--字体图标-->
<link href="${pageContext.request.contextPath}/static/default/js/javaex/pc/css/icomoon.css" rel="stylesheet" />
<!--动画-->
<link href="${pageContext.request.contextPath}/static/default/js/javaex/pc/css/animate.css" rel="stylesheet" />
<!--骨架样式-->
<link href="${pageContext.request.contextPath}/static/default/js/javaex/pc/css/common.css" rel="stylesheet" />
<!--皮肤（缇娜）-->
<link href="${pageContext.request.contextPath}/static/default/js/javaex/pc/css/skin/tina.css" rel="stylesheet" />
<!--uploadcss-->
<link href="${pageContext.request.contextPath}/static/default/js/webupload/webuploader.css" rel="stylesheet" />



<!--jquery，请勿轻易修改版本-->
<script src="${pageContext.request.contextPath}/static/default/js/javaex/pc/lib/jquery-1.7.2.min.js"></script>
<!--全局动态修改-->
<script src="${pageContext.request.contextPath}/static/default/js/javaex/pc/js/common.js"></script>
<!--核心组件-->
<script src="${pageContext.request.contextPath}/static/default/js/javaex/pc/js/javaex.min.js"></script>
<!--表单验证-->
<script src="${pageContext.request.contextPath}/static/default/js/javaex/pc/js/javaex-formVerify.js"></script>
<!--cookie-->
